...
//tealium universal tag - utag.sender.googleadwords ut4.0.201402262007, Copyright 2014 Tealium.com Inc. All Rights Reserved.
try{
(function(id,loader,u){
  ...
  u.map={"part_id_meta":"google_custom_params.ecomm_prodid","supplier_id":"google_custom_params.ecomm_supplier","gr_page_type":"google_custom_params.ecomm_pagetype"};
...
function(a,b){if(1){b['gr_page_type']='default'}},
function(a,b){if(b['dom.pathname']=='/'){b['gr_page_type']='home'}},
function(a,b){if((b['meta.wt.cg_n'].toString().toLowerCase().indexOf('Part Search'.toLowerCase())>-1&&b['meta.wt.cg_s'].toString().toLowerCase().indexOf('Part Detail'.toLowerCase())>-1)){b['gr_page_type']='product_detail'}},
function(a,b){if(b['dom.pathname'].toString().toLowerCase().indexOf('AddPart.aspx'.toLowerCase())>-1){b['gr_page_type']='cart'}},
function(a,b){if(b['page_title']=='Order Confirmation'){b['gr_page_type']='confirmation'}}];
